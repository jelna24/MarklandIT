    ...
    stateChange: function (fieldModel, state) {
      ...
      switch (to) {
        ...
        case 'activating':
          ...
          // something needs to be loaded (CSS/JavaScript/server data/â€¦), then
